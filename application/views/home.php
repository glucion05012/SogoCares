        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-8">
                        <img class="d-block img-fluid" src="./assets/carousel/WeHelp.jpg" alt="We Help">
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-8">
                        <img class="d-block img-fluid" src="./assets/carousel/WeListen.jpg" alt="We Listen">
                    </div>
                </div>
            </div>
        </div>
