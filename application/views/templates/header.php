...
<html lang="en">
  <head>
    ...
    <title>SogoCares</title>
    <link rel="shortcut icon" type="image/x-icon" href="<?= base_url('assets/logos/sogoCares.png'); ?>" />
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-114384353-4"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-114384353-4');
    </script>
